...
const seedDiseases = async () => {
  const diseases = [
    ...
    { name: "Eyes", speciality: "Ophthalmologist" },
    { name: "Mental", speciality: "Psychiatrist " },
    { name: "Female", speciality: "Gynaecology " },
    ...
    { name: "Blood", speciality: "Hematologists " },
    { name: "General", speciality: "General Physician" },
  ];
